...
Returns:    
    ...
    With 10 stocks and hardcoded stocks (no fundamentals getting updated daily)
    2011 Algo 32
    2012 Algo 210
    2013 Algo 0
    2014 Algo 12.5
...
def initialize(context):
    ...
    context.market_cap_max = 10000000000
    context.market_cap_min = 200000000
...
def sell_stock(context, stock, data):
    if stock in context.sold_for_the_day:
